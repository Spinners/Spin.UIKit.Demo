...
class RxSwiftTrendingViewController: UIViewController, StoryboardBased, Stepper {
...
extension RxSwiftTrendingViewController {
...
extension RxSwiftTrendingViewController: UITableViewDataSource {
...
extension RxSwiftTrendingViewController: UITableViewDelegate {
...
extension RxSwiftTrendingViewController {
    static func make(uiSpin: UISpin<Trending.State, Trending.Event>) -> RxSwiftTrendingViewController {
        let viewController = RxSwiftTrendingViewController.instantiate()
