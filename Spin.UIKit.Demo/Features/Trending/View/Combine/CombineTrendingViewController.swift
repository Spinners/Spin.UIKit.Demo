...
class CombineTrendingViewController: UIViewController, StoryboardBased, Stepper {
...
extension CombineTrendingViewController {
...
extension CombineTrendingViewController: UITableViewDataSource {
...
extension CombineTrendingViewController: UITableViewDelegate {
...
extension CombineTrendingViewController {
    static func make(uiSpin: UISpin<Trending.State, Trending.Event>) -> CombineTrendingViewController {
        let viewController = CombineTrendingViewController.instantiate()
