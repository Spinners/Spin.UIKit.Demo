...
class RxSwiftGifViewController: UIViewController, StoryboardBased {
...
extension RxSwiftGifViewController {
...
extension RxSwiftGifViewController {
    static func make(uiSpin: UISpin<Gif.State, Gif.Event>) -> RxSwiftGifViewController {
        let viewController = RxSwiftGifViewController.instantiate()
