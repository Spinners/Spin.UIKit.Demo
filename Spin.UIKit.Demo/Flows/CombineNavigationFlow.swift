...
final class CombineNavigationFlow: Flow {
...
extension CombineNavigationFlow {
    func navigateToTrending() -> FlowContributors {
        let viewController = self.resolver.resolve(CombineTrendingViewController.self)!
